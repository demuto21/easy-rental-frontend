              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                <div>
                  <AuthInput
                    ...
                    {...register("email")}
                  />
                  {errors.email && <span className="text-[10px] text-red-500 font-bold ml-1 mt-1 block tracking-wider">{errors.email.message}</span>}
                </div>
                <div>
                  <AuthInput
                    ...
                    {...register("password")}
                  />
                  {errors.password && <span className="text-[10px] text-red-500 font-bold ml-1 mt-1 block tracking-wider">{errors.password.message}</span>}
                </div>
                ...
                {authError && (
                  <div className="p-4 bg-red-50 dark:bg-red-900/20 border-2 border-red-100 dark:border-red-900/30 text-red-600 dark:text-red-400 text-[10px] font-black uppercase italic rounded-xl flex items-center gap-3">
                    <div className="size-2 bg-red-600 rounded-full animate-pulse" /> {authError}
                  </div>
                )}
