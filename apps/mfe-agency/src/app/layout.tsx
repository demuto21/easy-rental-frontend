...
import './globals.css';
import { AgencyAuthProvider } from './providers/auth-provider';
...
export const metadata: Metadata = {
  ...
  appleWebApp: { capable: true, statusBarStyle: 'default', title: 'Rental Agency' },
};

export const viewport: Viewport = {
  themeColor: '#0528d6', width: 'device-width', initialScale: 1, maximumScale: 1,
};
